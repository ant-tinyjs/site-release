...
(function (global, factory) {
  ...
  var Button = function (_InputBase) {
    ...
    function Button(options) {
      ...
      var thisOpacity = _this.getOpacity();
      var thisScaleX = _this.getScale().x;
      var thisScaleY = _this.getScale().y;
      ...
      _this.on('pointerup', leaveHandler);
      _this.on('pointermove', function (e) {});
      _this.on('pointerupoutside', leaveHandler);
      if (!Tiny.isMobile.any || !Tiny.config.viewTouched) {
        _this.on('click', clickHandler);
      }
      _this.on('tap', clickHandler);
      return _this;
    }
    createClass(Button, [{
      key: 'updatePosition',
